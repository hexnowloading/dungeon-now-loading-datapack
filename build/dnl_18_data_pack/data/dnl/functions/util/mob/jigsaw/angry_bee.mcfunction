...
summon minecraft:marker ~ ~2 ~ {Tags: ["dnl.marker", "dnl.spawner", "dnl.angry_bee"]}
setblock ~ ~ ~ structure_block[mode=save]{name: "dnl:mob/angry_bee", posX: 0, posY: 1, posZ: 0, sizeX: 1, sizeY: 3, sizeZ: 1, rotation: "NONE", mirror: "NONE", mode: "SAVE", ignoreEntities: 0b} replace

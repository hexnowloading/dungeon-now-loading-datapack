summon glow_item_frame ~ ~1 ~ {Facing: 1b, Invulnerable: 1b, Fixed: 0b, Tags: ["dnl.item_frame", "dnl.monolith", "dnl.monolith.crafter", "dnl.spawner_breaker", "dnl.new"], Item: {}}
...
execute as @e[type=glow_item_frame, tag=dnl.new] run function dnl:util/monolith/spawner_breaker/copy_data

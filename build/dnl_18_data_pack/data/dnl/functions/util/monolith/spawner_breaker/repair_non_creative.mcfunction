...
execute positioned ~ ~1 ~ unless entity @e[type=glow_item_frame, tag=dnl.monolith.crafter, distance=..1.1] at @s run function dnl:util/monolith/spawner_breaker/summon_item_frame

...
execute as @e[type=marker, tag=dnl.core, tag=dnl.frost_watcher, distance=..30] run function dnl:entity/frost_watcher/core/copy
execute unless entity @e[type=marker, tag=dnl.core, tag=dnl.frost_watcher, distance=..30] run function dnl:entity/frost_watcher/core/setup

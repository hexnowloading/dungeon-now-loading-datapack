function zzz_dnl_snowflake_boss_internal:animations/body_smash/resume_as_root
function zzz_dnl_snowflake_boss_internal:animations/body_smash/tween_as_root

function zzz_dnl_snowflake_boss_internal:animations/ice_shield/resume_as_root
function zzz_dnl_snowflake_boss_internal:animations/ice_shield/tween_as_root

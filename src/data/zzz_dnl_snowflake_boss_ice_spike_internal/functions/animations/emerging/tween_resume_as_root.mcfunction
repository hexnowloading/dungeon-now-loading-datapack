function zzz_dnl_snowflake_boss_ice_spike_internal:animations/emerging/resume_as_root
function zzz_dnl_snowflake_boss_ice_spike_internal:animations/emerging/tween_as_root
